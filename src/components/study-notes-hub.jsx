...
export function StudyNotesHubJsx() {
  ...
  const studyTopics = [
    ...
    { title: "C Programming", file: "c", image: "https://images.pexels.com/photos/52608/pexels-photo-52608.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", semesters: [1], semester2Title: "Advanced C Programming", progress: subjectProgress["c"] || { notes: false, handwritten: false } },
